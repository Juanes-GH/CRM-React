...
import {obtenerCliente, actulizarCliente} from "../data/clientes"
...
export async function action({request, params}){
    ...
    if(Object.values(datos).includes('')){
      errores.push('Todos los campos son obligatios')
    }
...
function EditarCliente() {
  ...
  return (
    ...
    <p className="mt-3 text-2l font-bold">A continuacion podras editar los datos de un cliente</p>
    ...
    <div className='flex justify-end'>
      ...
      <div className="bg-white shadow rounded-md md:w-3/4 mx-auto px-5 py-10 mt-20">
        ...
        >
          ...
          <input 
            type="submit"
            className="mt-5 w-full bg-blue-800 p-3 uppercase font-bold text-white text-lg rounded-sm"
